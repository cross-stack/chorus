  ...
  describe('Blinded Review Workflow Integration', () => {
    ...
    describe('error handling in workflow', () => {
      ...
      it('should handle database errors during reveal', async () => {
        ...
        // act & assert
        await expect(testDb.db.revealBallots(prRef)).rejects.toThrow('Database not initialized');
      });
      ...
      it('should handle database errors during phase check', async () => {
        ...
        // act & assert
        await expect(testDb.db.getPRPhase(prRef)).rejects.toThrow('Database not initialized');
      });
    });
